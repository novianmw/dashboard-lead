...
import { MainMenuItems } from "@/app/constant"
...
const MainMenu: React.FC<MainMenuProps> = ({ items, ...props }) => {
            ...
            <div className="w-full h-full flex flex-col items-start">
                <div className="flex flex-col items-start h-full w-full">
                    ...
                    <div className="w-full h-full flex flex-col justify-between items-center">
                        <nav className={cn("w-full flex flex-col items-start")} {...props}>
                            {/* {items.map((item) => (
                                <Button variant={"default"} key={item.href} >
                                    <Link href={item.href} className={`${pathname === item.href ? "bg-muted hover:bg-muted" : "hover:bg-transparent hover:underline"} w-full flex flex-row items-center p-8`}>
                                        {item.title}
                                    </Link>
                                </Button>
                            ))} */}
